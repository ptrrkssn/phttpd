...
DCL(int,logheadervolume,1);
DCL(int,rkmultimode,0);
DCL(int,mode_dotted,0);
DCL(int,softvirtserver,0);
...
DCL(int,restart_requests,0);
DCL(int,restart_grace_time,20);
DCL(int,log_fd,-1);
DCL(int,maxurlsize,256*1024);
DCL(int,do_restart,0);
DCL(int,already_daemon,0);
